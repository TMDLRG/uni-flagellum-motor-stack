# uni-flagellum-motor-stack — public mirror
...
filesystem paths, failure reports, adverse results and limitations. 114 operator-path, 12 internal-hostname, 46 private-address, 5 tailscale-address remain in this tree and are published as-is. Private network addresses are unroutable from the public internet and internal DNS names resolve
