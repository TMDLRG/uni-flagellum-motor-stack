# UNI-FLAGELLUM — public source snapshot

The bacterial flagellar-motor laboratory: licensed microscopy beside a deterministic reconstruction and an active-inference agent.
...
| | |
|---|---|
| source repository | `UNI-FLAGELLUM` (private) |
| branch | `hierarchical-aif/motor-stack` |
| commit | `b909801` |
| files published | 690 text files scanned, 31 top-level entries |
...
**5 occurrence(s) of third-party client identifiers were replaced with
...
77 structural matches (private addresses, internal DNS names, local filesystem
